...
void UGuitarTuningController::StartGuitarTuning()
{
}

void UGuitarTuningController::StopGuitarTuning()
{
}
...
void UGuitarSetupController::StartGuitarSetup()
{
	...
	MainCharacter->GetCharacterCameraComponent()->MoveCameraTo(GuitarSetupViewPlaceholder, 0.5f);
